...
function jry_wb_netdisk_init(body)
{
	var js_loading_count=0;
	js_loading_count++;jry_wb_include_once_script('jry_wb_nd_tools.js',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});
	js_loading_count++;jry_wb_include_once_script('jry_wb_nd_file.js',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});
	js_loading_count++;jry_wb_include_once_script('jry_wb_nd_upload_file.js.php',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});
	js_loading_count++;jry_wb_include_once_script('jry_wb_nd_area.js',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});
	js_loading_count++;jry_wb_include_once_script('jry_wb_nd_alert_list.js',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});
	js_loading_count++;jry_wb_include_once_script('jry_wb_nd_fresh_file_list.js',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});
	js_loading_count++;jry_wb_include_once_script('jry_wb_nd_fresh_share_list.js',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});
	js_loading_count++;jry_wb_include_once_script('jry_wb_nd_fresh.js',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});
	js_loading_count++;jry_wb_include_once_script('jry_wb_nd_show_files.js.php',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});
	js_loading_count++;jry_wb_include_once_script(jry_wb_message.jry_wb_host+'jry_wb_tp_sdk/aly/OSS/js/aliyun-oss-sdk-6.1.0.min.js',function(){if((--js_loading_count)==0)jry_wb_netdisk_show_index(body);});	
}
function jry_wb_netdisk_show_index(body)
{

<?php
	...
	function jry_nd_aly_upload($connect,$old_area,$area,$file,$new_file_name)
	{
		...
		$file_name=$old_area['config_message']->dir.constant('jry_nd_upload_file_prefix').$file['file_id'].'_jryupload';
	...
	function jry_nd_aly_upload_fast_buf($connect,$area,$file)
	{
		...
		$new_file_name=$area['faster_area']['config_message']->dir.constant('jry_nd_upload_file_prefix').$file['file_id'].'_jryupload'.$code;		

<?php
	...
	function jry_wb_get_ip_address($ip)
	{
		...
		require '../jry_wb_tp_sdk/ip2region/Ip2Region.php';
		$ip2region = new Ip2Region();
		$json=explode('|',$ip2region->btreeSearch($ip)['region']);
		if(!($json[4]==''&&$json[3]==''&&$json[2]==''&&$json[1]==''&&$json[0]==''))
		{
			$json='{"by":"ip2region","code":0,"data":{"ip":"'.$ip.'","isp":"'.$json[4].'","area":"","city":"'.$json[3].'","county":"XX","isp_id":"","region":"'.$json[2].'","area_id":"","city_id":"","country":"'.$json[0].'","county_id":"xx","region_id":"","country_id":""}}';

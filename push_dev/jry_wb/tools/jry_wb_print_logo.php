<?php 
	...
	function jry_wb_print_logo($active)
	{
		...
		echo '<a href="'.constant("jry_wb_host").$website['url'].'" target="_parent" class='.($active?'active':'').'>'.$website['show_name'].constant('jry_wb_name').'<img width="'.$width.'px" src="'.constant('jry_wb_logo_picture_address').'"></img></a>';
	}
?>
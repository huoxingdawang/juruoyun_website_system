<?php
	...
	jry_wb_print_head("登录",false,false,true);
?>
<?php echo jry_wb_include_css($jry_wb_login_user['style'],'mainpages/login'); ?>
		...
		<?php if(JRY_WB_OAUTH_SWITCH){ ?><tr>
			<td colspan="2">
                <div align="center">
					...
					<?php if(JRY_WB_TP_MI_OAUTH_CLIENT_ID!=''){?><span class="jry_wb_icon jry_wb_icon_xiaomi" onclick='milogin()' style='color:rgb(253, 88, 62);font-size:30px;' ></span><?php  }?>
                </div>
			</td>
		</tr><?php } ?>
	</table>

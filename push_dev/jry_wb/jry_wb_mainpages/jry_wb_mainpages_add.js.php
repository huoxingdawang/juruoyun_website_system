...
<?php if(JRY_WB_CHECK_TEL_SWITCH&&JRY_WB_SHORT_MESSAGE_SWITCH!=''){ ?>if(tel.value=="")
...
<?php } ?>
	...
	vcode.focus();
<?php if(JRY_WB_CHECK_TEL_SWITCH&&JRY_WB_SHORT_MESSAGE_SWITCH!=''){ ?>else if(phonecode.value=="")
	phonecode.focus();	
<?php } ?>
function check()
{ 

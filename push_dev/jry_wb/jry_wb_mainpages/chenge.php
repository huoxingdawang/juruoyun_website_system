...
<script language="javascript">
	...
	var jry_wb_tp_gitee_oauth_config_enable=<?php echo(constant ('jry_wb_tp_gitee_oauth_config_client_id')==''?'false':'true'); ?>;
	...
	var jry_wb_gitee_user_head='<?php if($jry_wb_login_user['oauth_gitee']!='')echo $jry_wb_login_user['oauth_gitee']->avatar_url;?>';

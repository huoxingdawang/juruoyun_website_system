...
<script language="javascript">
	...
	<?php if(constant('jry_wb_tp_github_oauth_config_client_id')!=''){ ?>var jry_wb_github_user_head='<?php if($jry_wb_login_user['oauth_github']!='')echo $jry_wb_login_user['oauth_github']->message->avatar_url;?>';<?php } ?>

...
function jry_wb_mainpages_login(area)
{
	...
	time2=0;
	time3=0;
	var body		=document.createElement('table')	;area	.appendChild(body)		;body		.classList.add('jry_wb_mainpages_login')	;body.setAttribute('align','center');

	...
	return (function e(t, n, r) {
		...
		5: [function(_dereq_, module, exports) {
			...
			var defaultConfig = exports.defaultConfig = {
				...
				reuseRedirectedURL: false // referrerPolicy: leave as unspecified
			};
			...
			var Features = function() {
				...
				_createClass(Features, null, [{
					...
					value: function supportNetworkStreamIO() {
						var ioctl = new _ioController2.default({},(0,
			...
			var AMF = function() {
				...
				_createClass(AMF, null, [{
					...
					value: function parseString(arrayBuffer, dataOffset, dataSize) {
						...
						if (length > 0) {
							str = (0,
							_utf8Conv2.default)(new Uint8Array(arrayBuffer,dataOffset + 2,length));
						} else {
							str = '';
						}
					...
					value: function parseLongString(arrayBuffer, dataOffset, dataSize) {
						...
						if (length > 0) {
							str = (0,
							_utf8Conv2.default)(new Uint8Array(arrayBuffer,dataOffset + 4,length));
						} else {
							str = '';
						}
							...
							case 3:
								{
									...
									value = {};
									var terminal = 0;
									// workaround for malformed Objects which has missing ScriptDataObjectEnd
							...
							case 8:
								{
									...
									value = {};
									offset += 4;
									// ECMAArrayLength(UI32)
									var _terminal = 0;
									// workaround for malformed MixedArrays which has missing ScriptDataObjectEnd
									if ((v.getUint32(dataSize - 4, !le) & 0x00FFFFFF) === 9) {
										_terminal = 3;
									}
				...
				_createClass(FLVDemuxer, [{
					...
					value: function _parseMP3AudioData(arrayBuffer, dataOffset, dataSize, requestHeader) {
						...
						if (requestHeader) {
							...
							var bit_rate = 0;
							var object_type = 34;
							// Layer-3, listed in MPEG-4 Audio Object Types
			...
			var SPSParser = function() {
				...
				_createClass(SPSParser, null, [{
					...
					value: function parseSPS(uint8array) {
						...
						// profile_idc
						gb.readByte();
						// constraint_set_flags[5] + reserved_zero[3]
		...
		31: [function(_dereq_, module, exports) {
			...
			var RangeLoader = function(_BaseLoader) {
				...
				function RangeLoader(seekHandler, config) {
					...
					_this._contentLength = null;
					// Content-Length of entire request range
					_this._receivedLength = 0;
					// total received bytes
					_this._lastTimeLoaded = 0;
					// received bytes of current request sub-range
					return _this;
				}
